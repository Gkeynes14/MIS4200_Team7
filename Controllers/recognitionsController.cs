...
namespace MIS4200_Team7.Controllers
{
    public class recognitionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "recognitionID,recognitionMessage")] recognition recognition)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "recognitionID,recognitionMessage")] recognition recognition)
        {
            if (ModelState.IsValid)
            {
